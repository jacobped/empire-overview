let gm; // will be assigned in init
...
export function getProgramData() {
  ...
  var Constant = {
    ...
    SettingData: {
      ...
      hideOnWorldView: { type: 'boolean', default: true, categories: 'visibility_category' },
      hideOnIslandView: { type: 'boolean', default: true, categories: 'visibility_category' },
      ...
      windowTennis: { type: 'boolean', default: true, categories: 'display_category' },
      ...
      birdSwarm: { type: 'boolean', default: true, categories: 'display_category' },
      ...
      compressedBuildingList: { type: 'boolean', default: true, category: 'building_category' },
      ...
      wineWarningTime: { type: 'number', default: 48, choices: [0, 12, 24, 36, 48, 96], categories: 'resource_category' },
      languageChange: { type: 'language', default: 'en', selection: ['en'], categories: 'language_category' },
    },
    SettingCategories: {
