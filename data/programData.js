(function () {
  ...
  function empire_asset_program_data(ikariamLanguage) {
    ...
    var Constant = {
      ...
      SettingData: {
        ...
        languageChange: { type: 'language', default: ikariamLanguage, selection: ['en'], categories: 'language_category' },
      },
      SettingCategories: {
  ...
  if (typeof window !== 'undefined') {
    window.empire_asset_program_data = empire_asset_program_data;
  } else if (typeof unsafeWindow !== 'undefined') {
    unsafeWindow.empire_asset_program_data = empire_asset_program_data;
  }
})();
